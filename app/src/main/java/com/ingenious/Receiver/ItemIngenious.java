 ...
 */public class ItemIngenious {

 	private String purchase_code, product_name, purchase_date, buyer_name, license_type, nemosofts_key, package_name;

	public ItemIngenious(String purchase_code, String product_name, String purchase_date, String buyer_name, String license_type, String nemosofts_key, String package_name) {
