 ...
 */public class AdapterGIFsFav extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            final ItemGIF item = arrayList.get(position);
            ...
            ((MyViewHolder) holder).my_image_view.setImageURI(Uri.parse(item.getImage()));
...
//                    adHolder.adChoicesContainer.removeAllViews();
                        ...
                        if (ad != null) {
//                adHolder.ll_main.setVisibility(View.VISIBLE);
