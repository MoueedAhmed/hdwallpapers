...
public class WallCIDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        methods = new Methods(WallCIDActivity.this, new InterAdListener() {
            @Override
            public void onClick(int position, String type) {
                int real_pos = adapter.getRealPos(position, arrayListTemp);

                Intent intent = new Intent(WallCIDActivity.this, WallpaperDetailsActivity.class);
        ...
        grid = new GridLayoutManager(WallCIDActivity.this, 3);
        grid.setSpanCount(3);
...
//        methods.showBannerAd(adView);
    ...
    private void getData() {
        ...
        },methods.getAPIRequest(Setting.METHOD_WALLPAPER_BY_CAT, page, "", getIntent().getStringExtra("cid"), "", "", "", "", "", "", "", "", ""));
        load.execute();
    ...
    public void setAdapter() {
        if (!isScroll) {
            adapter = new AdapterWallpaper(WallCIDActivity.this,  arrayList,  new RecyclerViewClickListener() {
                @Override
