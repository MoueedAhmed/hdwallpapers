...
public class MostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.most_view));
        ...
        methods = new Methods(MostActivity.this, new InterAdListener() {
            @Override
            public void onClick(int position, String type) {
                int real_pos = adapter.getRealPos(position, arrayListTemp);

                Intent intent = new Intent(MostActivity.this, WallpaperDetailsActivity.class);
        ...
        grid = new GridLayoutManager(MostActivity.this, 3);
        grid.setSpanCount(3);
...
//        methods.showBannerAd(adView);
    ...
    private void getData() {
        ...
        },methods.getAPIRequest(Setting.METHOD_MOST_VIEWED, page, "", "", "", "", "", "", "", "", "", "", ""));
        load.execute();
    ...
    public void setAdapter() {
        if (!isScroll) {
            adapter = new AdapterWallpaper(MostActivity.this,  arrayList,  new RecyclerViewClickListener() {
                @Override
